...
from student.models import Group,StudentAdmission,Student,Session
...
def admissionFormSubmit(request):
    ...
    return JsonResponse({'status': 'success','meaasge':'Account created Successfully','student':student},safe=False)
