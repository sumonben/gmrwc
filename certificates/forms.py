...
class CertificateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'father_name': forms.TextInput(attrs={'class': 'textfieldUSERinfo',  'placeholder':  'Father Name in English','onkeypress' : "myFunction(this.id)"}),
            'father_name_bangla': forms.TextInput(attrs={'class': 'textfieldUSERinfo',  'placeholder':  'Father Name in Bangla','onkeypress' : "myFunction(this.id)"}),
            'mother_name': forms.TextInput(attrs={'class': 'textfieldUSERinfo',  'placeholder':  'Mother Name in English','onkeypress' : "myFunction(this.id)"}),
            'mother_name_bangla': forms.TextInput(attrs={'class': 'textfieldUSERinfo',  'placeholder':  'Mother Name in Bangla','onkeypress' : "myFunction(this.id)"}),
